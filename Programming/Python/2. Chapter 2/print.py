print("HI there, python doesn't need semicolon")
print("check")
...
print('''My love, my love, my fearless love,
My love will never Die
                          - Lucifer''')

# above multiline string could also have been printed using multiple print commands